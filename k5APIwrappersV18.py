#!/usr/bin/python
"""Summary: My Python K5 API Wrapper tutorial library
...
def main():
   ...
   # k5token = get_unscoped_token(adminUser, adminPassword, contract, region).headers['X-Subject-Token']
    ...
    k5tokenA = get_scoped_token(adminUser, adminPassword, contract, demoProjectAid, region).headers['X-Subject-Token']
    k5tokenB = get_rescoped_token(k5tokenA, demoProjectBid, region).headers['X-Subject-Token']
